...
/*const[user, setUser] = useState({
      ...
      return(
            ...
            <div className='mb-4'>
                  <label htmlFor="title" className='block text-gray-700 text-sm font-fold mb-2'>Dale nombre a tu historia</label>
            ...
            <div className='mb-4'>
                  <label htmlFor="story" className='block text-gray-700 text-sm font-fold mb-2'>Cuéntanos tu historia</label>
